...
### Search by Brands 🔍
- **Quick Brand Search**: Allows users to filter products by their favorite brands, making the shopping experience more personalized. 🏷️
...
This version now places the screenshots at the top of the **README**, providing an immediate visual representation of the app!
